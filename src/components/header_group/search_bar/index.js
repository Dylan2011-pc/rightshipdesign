...
const SearchBar = observer(() => {
    ...
    return (
        <div className={`bg-[#F5F5F5] max-[639px]:bg-transparent min-[1366px]:w-[500px] rounded-[6px] flex justify-start items-center h-full min-[600px]:pr-3`}>
            ...
            <img onClick={clearSearchInputValue} className='w-[20px] h-[20px] max-[639px]:hidden peer-placeholder-shown:hidden block cursor-pointer' src={XiconInput} alt="" />
        </div>
    );
  });
